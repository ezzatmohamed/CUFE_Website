            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Edit </a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon ti-pencil"></i><a href="/editprofile"> Edit Profile</a></li>
                           
                             <li><i class="menu-icon ti-pencil"></i><a href="/settings">Edit Settings</a></li>
                        </ul>
