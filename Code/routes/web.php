...
Route::post('/home','PostController@SharePost');
...
Route::get('/planner','PlannerController@ViewPlanner');
Route::get('/editplanner','PlannerController@ViewEdit');
Route::post('/editplanner','PlannerController@EditPlanner');